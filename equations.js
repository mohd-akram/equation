...
(function() {
  ...
  window.onload = function() {
    var Timer, changeBrackets, chars, equationBox, findAllIndexes, findAndReplace, findBracket, fontSize, funcregex, functions, i, inputBox, insertAtCursor, keyCodeMap, keys, lettersregex, message, miscregex, needBracket, timer, trigfunctions, trigregex, updateBox, updateMath, _i, _len;
