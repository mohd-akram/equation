...
(async function() {
  var equation, equationBox, i, inputBox, inputBoxes, len, parent;

  inputBoxes = (location.href.startsWith('https://chrome.google.com/webstore') ? null : document.querySelectorAll('input[id*=AnSwEr]'));
