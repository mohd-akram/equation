...
(function() {
  var className, createDataTransfer, enableInputBox, forgetEquation, i, imageToDataURL, imgURL, inputBox, inputBoxes, knownEquation, len, longResponseClassName, observer, picker, ref, rememberEquation, removeOldEquations, shortResponseClassName;
  ...
  enableInputBox = function(element) {
    var button, elementValue, equation, equationBox, hide, image, show, wrapper;
    if (!element) {
      return;
    }
