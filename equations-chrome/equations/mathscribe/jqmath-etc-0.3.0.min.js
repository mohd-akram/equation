...
M.parseMathQ=true;window.onload=function(){if(M.MathML==null)M.MathML=M.canMathML();if(M.parseMathQ)try{M.parseMath(document.body)}catch(exc){alert(exc)}};return M}();var M;if(M===undefined)M=jqMath;
